...
@auth
    @if(Auth::user()->role == 'admin')
        ...
        <div class="min-h-screen bg-gray-100">
            <form class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10" action="{{ route('insert') }}"
                  method="POST">
                @csrf
                @if($errors->any())
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            ...
                            required id="grid-first-name" name="firstname" type="text" placeholder="Jane">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input
                            ...
                            required name="lastname" id="grid-last-name" type="text" placeholder="Doe">
                        <p class="text-red-500 text-xs italic">Обязательное поле.</p>
