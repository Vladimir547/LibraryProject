    ...
    @auth
        @if(Auth::user()->role == 'admin' or Auth::user()->id == $book->author->user_id )
            <div class="min-h-screen bg-gray-100">
                <form class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10" action="{{ asset("/book/update/$book->id") }}"
                      method="POST">
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                ...
                                required id="grid-first-name" name="title" type="text" placeholder="Jane" value="{{ $book->Title }}">
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                ...
                                id="grid-first-name" type="text" name="genre" placeholder="Фантастика" value="{{ $book->genre }}">
                        </div>
                        <div class="w-full px-3">
                            ...
                            <textarea id="message" rows="4"
                                      ...
                                      placeholder="Write your thoughts here..." name="description">{{ $book->description }}</textarea>
                        </div>
